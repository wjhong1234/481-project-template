...
Looking back on the development of our Lo-Fi prototype, we feel each stage was beneficial to our app's design. During Sketching/Brainstorming, we came up with several new ideas. Even though some were a bit extreme in application, the peer evaluation for each sketch helped us see what was realistic, and helped us decide on the functionalities that would be included in the app while still maintaining our goal of making it easy to use.

Interacting with the prototype we feel was the most beneficial. During the video prototype stage, we found that there were some issues with some of our interactions, and made notes on what we would like to change. Pretending to be Freya in the walkthrough helped us see first hand what flaws we had in our design, which initially didn't come to mind.
